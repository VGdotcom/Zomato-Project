document.addEventListener('DOMContentLoaded', () => {
    ...
    const foodImages = {
        'italian': '/static/food_pasta.png',
        'pasta': '/static/food_pasta.png',
        'continental': '/static/food_pasta.png',
        'french': '/static/food_french.png',
        'bakery': '/static/food_french.png',
        'dessert': '/static/food_french.png',
        'fusion': '/static/food_fusion.png',
        'seafood': '/static/food_fusion.png',
        'asian': '/static/food_chinese.png',
        'chinese': '/static/food_chinese.png',
        'japanese': '/static/food_chinese.png',
        'thai': '/static/food_chinese.png',
        'indian': '/static/food_indian.png',
        'north indian': '/static/food_indian.png',
        'south indian': '/static/food_indian.png',
        'mughlai': '/static/food_indian.png',
        'biryani': '/static/food_indian.png',
        'cafe': '/static/food_cafe.png',
        'coffee': '/static/food_cafe.png',
        'healthy': '/static/food_fusion.png',
        'salad': '/static/food_fusion.png',
        'mediterranean': '/static/food_fusion.png',
    };

    // Default images pool for random assignment
    const defaultImages = [
        '/static/food_pasta.png',
        '/static/food_french.png',
        '/static/food_fusion.png',
        '/static/food_indian.png',
        '/static/food_chinese.png',
        '/static/food_cafe.png',
    ];
